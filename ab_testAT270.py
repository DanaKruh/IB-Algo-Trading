...
def ab_testAT270(ib):
    ...
    option1 = Option('AAPL', '20200409', 270.0, 'C', 'SMART', tradingClass='AAPL')
    option2 = Option('AAPL', '20200409', 275.0, 'C', 'SMART', tradingClass='AAPL')
    option3 = Option('AAPL', '20200409', 280.0, 'C', 'SMART', tradingClass='AAPL')
    ...
    option1 = Option('AAPL', '20200409', 285.0, 'C', 'SMART', tradingClass='AAPL')
    option2 = Option('AAPL', '20200409', 290.0, 'C', 'SMART', tradingClass='AAPL')
    ...
    option1 = Option('AAPL', '20200409', 295.0, 'C', 'SMART', tradingClass='AAPL')
    option2 = Option('AAPL', '20200409', 300.0, 'C', 'SMART', tradingClass='AAPL')
    contracts = [option1, option2]
    ib.qualifyContracts(*contracts)
    leg1 = ComboLeg()
    leg1.conId = option1.conId  # DBK JUN 21 2019 C
    ...
    option1 = Option('AAPL', '20200409', 305.0, 'C', 'SMART', tradingClass='AAPL')
    option2 = Option('AAPL', '20200409', 310.0, 'C', 'SMART', tradingClass='AAPL')
    contracts = [option1, option2]
    ib.qualifyContracts(*contracts)
    leg1 = ComboLeg()
    leg1.conId = option1.conId  # DBK JUN 21 2019 C
